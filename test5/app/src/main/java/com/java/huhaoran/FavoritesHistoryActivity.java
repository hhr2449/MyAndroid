...
public class FavoritesHistoryActivity extends AppCompatActivity {
    ...
    private HistoryItemAdapter favoritesHistoryAdapter;


    //获取控件
    private void getViewById() {
        clearButton = findViewById(R.id.clear_button_favorites);
        deleteButton = findViewById(R.id.delete_button_favorites);
        backButton = findViewById(R.id.back_button_favorites);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_favorites_history);
    ...
    private void loadMoreNewsData() {
        ...
        new Thread(() -> {
            ...
            if (favoritesHistoryNotes != null && favoritesHistoryNotes.size() > 0) {
                List<FetchNews.NewsItem> newslist = TransferHistoryToNewsItem.transfer2(favoritesHistoryNotes);
    ...
    private void initView() {
        ...
        deleteButton.setOnClickListener(v -> {
            ...
            if(isEdit) {
                //获取要删除新闻的标题
                HashSet<String> titlesToRemove = favoritesHistoryAdapter.getTitlesToRemove();
            ...
            isEdit = !isEdit;
            //改变编辑模式
            favoritesHistoryAdapter.setEditMode(isEdit);
            //改变按键的文字
